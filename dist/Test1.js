...
const testCases = [
    { a: 1, b: 0, op: '+', expected: 2, testId: 1001 },
    { a: 5, b: 0, op: '-', expected: 2, testId: 1002 },
    { a: 4, b: 0, op: '*', expected: 8, testId: 1003 }, // example new test case
    { a: 10, b: 0, op: '/', expected: 5, testId: 1004 },
    { a: 10, b: 10, op: '/', expected: null, testId: 1005 } // example new test case
];
